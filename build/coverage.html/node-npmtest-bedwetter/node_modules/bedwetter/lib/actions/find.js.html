...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-bedwetter/node_modules/bedwetter/lib/actions/find.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-bedwetter/node_modules/bedwetter/lib/actions/find.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-bedwetter/node_modules/bedwetter/lib/actions/</a> &#187; find.js</div>
</div>
<div class="body">
 ...
 */
&nbsp;
module.exports = <span class="fstat-no" title="function not covered" >function findRecords (route, origOptions) {</span>
...
<span class="cstat-no" title="statement not covered" >      query = Model.count()</span>
      .where( actionUtil.parseCriteria() );
      
    } else {
      
<span class="cstat-no" title="statement not covered" >      query = Model.find()</span>
      .where( actionUtil.parseCriteria() )
...
<span class="cstat-no" title="statement not covered" >    query.exec(<span class="fstat-no" title="function not covered" >function found(err, matchingRecords) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        actionUtil.omitFields(matchingRecords);</span>
      }
      
      // If count is set, this this an integer.  Otherwise, it's an array of matching records.
<span class="cstat-no" title="statement not covered" >      return reply(matchingRecords);</span>
