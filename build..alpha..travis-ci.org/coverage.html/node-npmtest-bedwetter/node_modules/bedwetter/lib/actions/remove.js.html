...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-bedwetter/node_modules/bedwetter/lib/actions/remove.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-bedwetter/node_modules/bedwetter/lib/actions/remove.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-bedwetter/node_modules/bedwetter/lib/actions/</a> &#187; remove.js</div>
</div>
<div class="body">
 ...
 */
&nbsp;
module.exports = <span class="fstat-no" title="function not covered" >function remove(route, origOptions) {</span>
...
<span class="cstat-no" title="statement not covered" >    var childPk;</span>
    
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      childPk = actionUtil.requirePk(true);</span>
    } catch(e) {
<span class="cstat-no" title="statement not covered" >      return reply(Boom.wrap(e)); </span>
    }
    
<span class="cstat-no" title="statement not covered" >    Model</span>
    .findOne(parentPk).populate(relation, childPk).exec(<span class="fstat-no" title="function not covered" >function found(err, parentRecord) {</span>
      
<span class="cstat-no" title="statement not covered" >      if (err)</span>
<span class="cstat-no" title="statement not covered" >        return reply(WL2Boom(err));</span>
      
      // That parent record wasn't found
<span class="cstat-no" title="statement not covered" >      if (!parentRecord)</span>
<span class="cstat-no" title="statement not covered" >        return reply(Boom.notFound());</span>
      
      // Check parent record owner
<span class="cstat-no" title="statement not covered" >      if (!actionUtil.validOwnership(parentRecord, false))</span>
<span class="cstat-no" title="statement not covered" >        return reply(Boom.unauthorized());</span>
      
      // That child record wasn't found.
<span class="cstat-no" title="statement not covered" >      if (!parentRecord[relation] || !parentRecord[relation][0])</span>
<span class="cstat-no" title="statement not covered" >        return reply(Boom.notFound());</span>
      
      // Check child record owner
<span class="cstat-no" title="statement not covered" >      if (!actionUtil.validOwnership(parentRecord[relation][0], true))</span>
<span class="cstat-no" title="statement not covered" >        return reply(Boom.unauthorized());</span>
      
<span class="cstat-no" title="statement not covered" >      parentRecord[relation].remove(parentRecord[relation][0][childPkAttr]);</span>
      
<span class="cstat-no" title="statement not covered" >      parentRecord.save(<span class="fstat-no" title="function not covered" >function(err, parentRecordSaved) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        RequestState.primaryRecord   = parentRecordSaved;</span>
<span class="cstat-no" title="statement not covered" >        RequestState.secondaryRecord = parentRecord[relation][0];</span>
